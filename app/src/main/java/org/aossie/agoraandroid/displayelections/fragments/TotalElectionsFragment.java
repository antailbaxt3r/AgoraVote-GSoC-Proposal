...
public class TotalElectionsFragment extends Fragment {

  private final ArrayList<Election> electionList = new ArrayList<>();
  public TotalElectionsFragment() {
  }
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    RecyclerView rvElectionDetails = view.findViewById(R.id.rv_total_elections);
